            ...
            <div class="col-md-6 column">
                <form class="form-horizontal" role="form" action="addbook" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="form_input_5" name="book.PublishDate" type="text" placeholder="2005-1"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="form_input_6" name="book.Publisher" type="text" placeholder="人民文学出版社"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="form_input_7" name="book.ImageUrl" type="text" placeholder="请输入图片Url地址，勿添加本地链接"/>
                        </div>
                    </div>
