                ...
                <div class="col-md-6 column">
                    <form class="form-horizontal" role="form" action="addbookauthor" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <s:textfield class="form-control" required="true" id="form_input_2_4" name="author.AuthorID" type="text" value="%{item.AuthorID}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 text-primary">
                                <s:textfield class="form-control" id="form_input_2_1" name="author.BirthDate" type="text" value="%{item.BirthDate}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <s:textfield class="form-control" id="form_input_2_2" name="author.Country" type="text" value="%{item.Country}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <s:textfield class="form-control" id="form_input_2_3" name="author.AuImageUrl" type="text" value="%{item.AuImageUrl}"/>
                            </div>
                        </div>
