                    ...
                    <form class="form-horizontal" role="form" action="addbookauthor" method="post">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <s:property value="item.AuthorID"/>
                                                    </td>
                                                    <td>
                                                        <s:property value="item.Name"/>
                                                    </td>
                                                    <td>
                                                        <s:property value="item.BirthDate"/>
                                                    </td>
                                                    <td>
                                                        <s:property value="item.Country"/>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 text-primary">
                                <s:textfield class="form-control" required="true" id="form_input_2_1" name="author.BirthDate" type="text" value="%{item.BirthDate}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <s:textfield class="form-control" required="true" id="form_input_2_2" name="author.Country" type="text" value="%{item.Country}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <s:textfield class="form-control" required="true" id="form_input_2_3" name="author.AuImageUrl" type="text" value="%{item.AuImageUrl}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <s:textfield class="form-control" required="true" id="form_input_7" name="book.ImageUrl" type="text" value="%{book.ImageUrl}"/>
                            </div>
                        </div>
