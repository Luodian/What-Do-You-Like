        ...
        <div class="col-md-12 column">
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-6 column pull-right">
                    ...
                    <p>
                        ID：<s:property value="Author.AuthorID"/>
                    </p>
                    <p>
                        <br>
                        <br>
                ...
                <div class="col-md-4 column pull-left">
                    <img src='<s:property value="Author.AuImageUrl"/>' class="img-thumbnail img-responsive"  alt="Responsive image" width="300" height="300"/>
                </div>
            </div>
            <div class="row clearfix">
                <div class="col-md-12 column">
